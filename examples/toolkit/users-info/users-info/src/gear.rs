...
use toolkit::{DatabaseCapability, Gear, GearCtx, RestApiCapability, SseBroadcaster};
...
/// This lives in the composition root (gear.rs) to avoid infra dependencies in domain.
